...
**Task 2: Why is the "no_details" entry so high? Did the code incorrectly capture our data cleaning? Were there really 68 death certificates with no entries at all?**
...
**Task 3: Create additional medical timeline graphics from the summary_long data**
