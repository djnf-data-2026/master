---
title: "TidyCensus in Arkansas"
author: "Rob Wells"
date: "May 28 2026"
output: html_document
---
# Arkansas Prisons and their Host Towns
As we discussed, you will continue to develop the work on Arkansas prisons and demographics, contrasting the prison population to that of their host communities.

The project also will determine the disparity in wages in the prison Census tracts versus the surrounding counties.

You’ll create maps and charts with the results.

The next step is to use tidycensus to get demographics (population by race in a census tract) and join that with your prison map. And then you would use Leaflet and tooltips to displace the demographics in a pop up box.

You want to read this:
https://www.census.gov/data/what-is-data-census-gov/guidance-for-data-users/getting-started.html
...
race_dec <- tidycensus::get_decennial( geography = "tract", geometry = TRUE, state = "AR", year = 2020, variables = "P1_003N", summary_var = "P1_002N") 

black <- tidycensus::get_decennial( geography = "tract", geometry = TRUE, state = "AR", year = 2020, variables = "P1_004N", summary_var = "P1_002N") 
...
#Calls variables for the American Community Survey census
```{r}
...
#Race by Arkansas County, 2020
```{r}


AR_race <- get_decennial(geography = "county", geometry = TRUE, state = "AR", year = 2020, variables = c(white = "P1_003N", black = "P1_004N", asian = "P1_006N", nativeam = "P1_005N", hispanic = "P2_002N"), summary_var = "P1_002N") %>% 
 mutate(pct_race = (value / summary_value)) %>% 
  rename(race = variable, population = value, county_pop = summary_value)

AR_race$pct_race <- round(AR_race$pct_race, 2)
AR_race$pct_race <- percent(AR_race$pct_race, 0)
...
#B01001_001 COUNTS Population
population_inc_2024 <- get_acs(geography = "state", 
              variables = c(total_pop = "B01001_001"), 
               year = 2024) 

write_csv(population_inc_2024, "population_inc_2024.csv")
...
#P3_001N RACE FOR THE POPULATION 18 YEARS AND OVER
