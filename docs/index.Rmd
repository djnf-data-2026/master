...
- **2 p.m.**: Welcome at Knight Hall Eaton Theater. Wells Denny, Lang
  and Shirley Carswell, DJNF Executive Director
  - Logistics. The week ahead. Rooms meals.
  - Student introductions.
- **3:30 p.m.**: Break
- **3:45 p.m.**: Investigate Your Community.
  - Review starter code, data memos, develop story ideas. Wells. Eaton
    Theater\
...
- **9 a.m. - 10:30 a.m.: Skills sessions**
  ...
  - Coding Experienced Track: Using AI with R. (Derek Willis, the Howard
    ...
    - Knight Hall Room 2103
  - New to Coding Track: Data cleaning. (Aidan Hughes, the Howard
    Center)
...
- **11 a.m.**: Workshop. Students work on data gathering story pitches.
  (Wells, Willis, Hughes, TA as coaches). Room 1101
...
- **6:30 p.m.**: Dinner in Hyattsville. (Meet at Knight Hall board van.
  Wells / driving)
...
- **11:30 a.m. - 12:30 p.m.**: Keynote speaker: [Jon Schleuss,
  President, The News Guild](https://newsguild.org/staff/). All attend.
  Eaton Theater.

  - [Readings before Jon Schleuss talk](TK%20TK%20TK) TK TK TK
  - Lunch with Schleuss
...
- **11:59 p.m.**: Second draft of story pitch memos due. –A minimum of
  ...
  and a discussion of potential holes. The best pitches will cover two
  topics and have a rendered page from your GitHub account. Submit as an
...
- **8:15 a.m.**: Meet at Knight Hall, board van, depart for College Park
  Metro (Wells driving)
