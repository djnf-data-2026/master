...
- **3:45 p.m.**: Investigate Your Community.
  ...
  - New to Coding Track, getting started with R: Casey, Izzy, Laine (Lang) Knight 2103  
...
- **11 a.m.**: Workshops: Use data to find stories. (Wells, Hughes, Lang)
  Rooms 2103, 2107
...
- **11:30 a.m. - 12:30 p.m.**: Keynote speaker: [Jon Schleuss,
  President, The News Guild](https://newsguild.org/staff/). Eaton Theater.

  - [Readings before Jon Schleuss talk](TK%20TK%20TK) TK TK TK
  
- **12:30 p.m.**: Lunch with Schleuss

- **1:30 p.m. - 2:30 p.m.**: Introduction to business reporting. (Wells). Eaton Theater
