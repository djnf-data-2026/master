...
- **11:30 a.m. - 12:30 p.m.**: Keynote speaker: [Jon Schleuss,
  ...
  - [Presentation slides](https://docs.google.com/presentation/d/1EaLQ0Ez4DeTWO0YLH6rryDmHhto_LON_LG6ZKv9oiVo/edit?usp=sharing)
...
- **1:30 p.m. - 2:30 p.m.**: Introduction to business reporting.
  ...
  - [Slides from presentation](https://docs.google.com/presentation/d/1pkNXrPdX4MNCrmpfpqlBd4y1eKh6KFK2/edit?usp=sharing&ouid=102324743793755798467&rtpof=true&sd=true)
  - [Business reporting cheat sheet](https://docs.google.com/document/d/1RHzcqIGuzfEtUEQ5w8jYWqTpnxNa6-5j/edit?usp=sharing&ouid=102324743793755798467&rtpof=true&sd=true)
...
- **11:59 p.m.**: Second draft of story pitch memos due. 
  ...
  –A minimum of   600 words, this will build on Monday’s work. It will include at least one graphic, building on the Tuesday graphics workshop, and some summary data analysis, building on the data workshops since Sunday. This pitch should include summary tables, basic analysis, questions,
and a discussion of potential holes. It will include a paragraph about a major employer in your community that's important to watch. The best pitches will cover two topics and have a rendered page from your GitHub account. Submit as rendered web page, for example: https://djnf-data-2026.github.io/julie-lee/

And include the link to your source file, for example: https://github.com/djnf-data-2026/julie-lee/blob/main/docs/index.qmd

-- Email links to Wells: [robwells\@umd.edu](mailto:robwells@umd.edu){.email}
...
- **9:00 a.m.**: Present your story pitch to the group. –This will be a
  ...
  interns have the option of presenting slides. One story
  pitch will be presented, along with questions and a discussion of
