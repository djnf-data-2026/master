...
### NOT FOR PUBLICATION: DEC 7 2025 DRAFT 

# Death Certificates of Cheltenham, Jessup Youth
...
gs4_deauth()  
extracted_dc <- read_sheet("https://docs.google.com/spreadsheets/d/13CthhhfLHiPZqr1P67SCa9BVUyb5Rl6OBhUwvqawDEk/edit?usp=sharing", sheet = "master_deaths_dec_5", col_types ="c") |> 
     clean_names() |> 
...
extracted_dc$death_date_clean <- sapply(extracted_dc$death_date1, standardize_date)
extracted_dc$death_date_clean <- as.Date(extracted_dc$death_date_clean, origin = "1970-01-01")
```
...
```{r echo=FALSE}
extracted_dc |> 
  rename(Age = approx_age, Death_Date = death_date_clean, Name = name, Cause = cause_of_death, Race = color_or_race) |> 
