...
gs4_deauth()  
extracted_dc <- read_sheet("https://docs.google.com/spreadsheets/d/13CthhhfLHiPZqr1P67SCa9BVUyb5Rl6OBhUwvqawDEk/edit?usp=sharing", col_types = "c") |> 
     clean_names() |> 
...
ggplot(aes(x = approx_age, y = total, fill = total)) +
  ...
  labs(title = "Ages of Cheltenham, Jessup youth deaths",
       ...
       caption = "n=172. Graph does not have ages for 15 individuals. Graphic by Rob Wells, 11-30-2023",
       y="Number",
       x="Approximate Ages")
